...
function createOldWiki(root: string): void {
  for (const dir of ["_system/scripts", "skills/compile-wiki/scripts", "skills/process-inbox", "agent_wiki", "sources", "_system/cache", "_system/indexes", "_system/logs"]) {
  ...
  writeFileSync(join(root, "README.md"), "Run python3 _system/scripts/create-page.py then python3 skills/compile-wiki/scripts/compile.py\n", "utf8");
